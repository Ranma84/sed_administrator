    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Sed Cargo Edit</h3>
            </div>
			<?= form_open('sed_cargo/edit/'.$sed_cargo['id_cargo']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_area" class="form-control">
								...
								{
									$selected = ($sed_area['id_area'] == $sed_cargo['id_area']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_dpto" class="form-control">
								...
								{
									$selected = ($sed_departamento['id_dpto'] == $sed_cargo['id_dpto']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_nivel" class="form-control">
								...
								{
									$selected = ($sed_nivele['id_nivel'] == $sed_cargo['id_nivel']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="nombre" value="<?= ($this->input->post('nombre') ? $this->input->post('nombre') : $sed_cargo['nombre']); ?>" class="form-control" id="nombre" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="plazas" value="<?= ($this->input->post('plazas') ? $this->input->post('plazas') : $sed_cargo['plazas']); ?>" class="form-control" id="plazas" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="estado" value="<?= ($this->input->post('estado') ? $this->input->post('estado') : $sed_cargo['estado']); ?>" class="form-control" id="estado" />
						</div>
					</div>
				</div>
			</div>
