...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?= site_url('bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css'); ?>">        
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="<?= base_url('Auth/logout') ?>" class="dropdown-toggle">
                                    <span class="hidden-xs">Cerrar Sección</span>
                                </a>
                                <ul class="dropdown-menu">
                                    <!-- User image -->
...
<!--                                        <p>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
						...
						<li class="treeview">
                            <a href="#">
                                <i class="fa fa-columns"></i> <span>Tbparametro</span>
								 <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
								<li class="active">
                                    <a href="<?php echo site_url('tbparametro/add');?>"><i class="fa fa-plus"></i> Añadi</a>
                                </li>
								<li>
                                    <a href="<?php echo site_url('tbparametro/index');?>"><i class="fa fa-list-ul"></i> Lista</a>
                                </li>
							</ul>
                        </li>
        ...
        <script src="<?= site_url('resources/bower_components/datatables.net/js/jquery.dataTables.min.js'); ?>"></script>
        <script src="<?= site_url('resources/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js'); ?>"></script>
