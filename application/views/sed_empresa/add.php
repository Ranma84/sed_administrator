    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Sed Empresa Add</h3>
            </div>
            <?= form_open('sed_empresa/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						<label for="nombre_comercial" class="control-label"><span class="text-danger">*</span>Nombre Comercial</label>
						<div class="form-group">
							<input type="text" name="nombre_comercial" value="<?= $this->input->post('nombre_comercial'); ?>" class="form-control" id="nombre_comercial" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="ced_ruc" value="<?= $this->input->post('ced_ruc'); ?>" class="form-control" id="ced_ruc" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="direccion" value="<?= $this->input->post('direccion'); ?>" class="form-control" id="direccion" />
