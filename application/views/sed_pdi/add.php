    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Sed Pdi Add</h3>
            </div>
            <?= form_open('sed_pdi/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_periodo" class="form-control">
								...
								{
									$selected = ($sed_periodo['id_periodo'] == $this->input->post('id_periodo')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="periocidad" value="<?= $this->input->post('periocidad'); ?>" class="form-control" id="periocidad" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="mejora" class="control-label">Mejora</label>
						<div class="form-group">
							<input type="text" name="mejora" value="<?= $this->input->post('mejora'); ?>" class="form-control" id="mejora" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="accion" value="<?= $this->input->post('accion'); ?>" class="form-control" id="accion" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="tipo" value="<?= $this->input->post('tipo'); ?>" class="form-control" id="tipo" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="fec_inicio" class="control-label">Fec Inicio</label>
						<div class="form-group">
							<input type="text" name="fec_inicio" value="<?= $this->input->post('fec_inicio'); ?>" class="has-datepicker form-control" id="fec_inicio" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="fec_fin" class="control-label">Fec Fin</label>
						<div class="form-group">
							<input type="text" name="fec_fin" value="<?= $this->input->post('fec_fin'); ?>" class="has-datepicker form-control" id="fec_fin" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="presupuesto" class="control-label">Presupuesto</label>
						<div class="form-group">
							<input type="text" name="presupuesto" value="<?= $this->input->post('presupuesto'); ?>" class="form-control" id="presupuesto" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="resultado" class="control-label">Resultado</label>
						<div class="form-group">
							<input type="text" name="resultado" value="<?= $this->input->post('resultado'); ?>" class="form-control" id="resultado" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="avance" value="<?= $this->input->post('avance'); ?>" class="form-control" id="avance" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="fec_ingreso" value="<?= $this->input->post('fec_ingreso'); ?>" class="has-datepicker form-control" id="fec_ingreso" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="id_periodo_detalle" value="<?= $this->input->post('id_periodo_detalle'); ?>" class="form-control" id="id_periodo_detalle" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="id_evaluado" value="<?= $this->input->post('id_evaluado'); ?>" class="form-control" id="id_evaluado" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="id_competencia" value="<?= $this->input->post('id_competencia'); ?>" class="form-control" id="id_competencia" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="id_evaluador" value="<?= $this->input->post('id_evaluador'); ?>" class="form-control" id="id_evaluador" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="id_mentor" value="<?= $this->input->post('id_mentor'); ?>" class="form-control" id="id_mentor" />
